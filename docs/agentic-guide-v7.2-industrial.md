...
### todo 
- harden spec driven development
- add github copilot/antigravity specific instructions
- add ripgrep to CI and to agent instructions
- bandit security scanner vs snyk
- non mcp alternatives
- sentry integration
- apify,tavily,firecrawl,serpapi websearch 
---
